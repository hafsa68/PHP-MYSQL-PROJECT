            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted"><?= htmlspecialchars($course->title); ?></span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong><?= ($course->discounted_price > 0) ? $course->discounted_price : $course->price; ?></strong>
                    </li>
                </ul>
            </div>
...
<input type="hidden" name="amount" value="<?= ($course->discounted_price > 0) ? $course->discounted_price : $course->price; ?>" required/>
<input type="hidden" name="course_id" value="<?= $course->id; ?>">

<button class="btn btn-primary btn-lg btn-block" type="submit">Continue to checkout (Hosted)</button></form>
            </div>
        </div>
