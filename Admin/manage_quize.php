...
// Fetch quizzes
$list = $db->query("SELECT * FROM quizzes ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en"
    dir="ltr">
...
<div class="container mt-4">
    ...
    <?php endif; ?>
    <a href="quize_form.php" class="btn btn-primary mb-3">Add Quiz</a>
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="quize_form.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                <a href="?delete_id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this quiz?')">Delete</a>
                <a href="questions.php?quiz_id=<?= $row['id'] ?>" class="btn btn-sm btn-info">Questions</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
