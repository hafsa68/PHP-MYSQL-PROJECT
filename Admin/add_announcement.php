...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO announcements (course_id, teacher_id, title, content, is_pinned) 
              VALUES ($course_id, $teacher_id, '$title', '$content', $is_pinned)";
...
<div class="container">
    ...
    <a href="list_announcements.php" class="btn btn-success">View List</a>
</div>
