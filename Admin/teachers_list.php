...
<div class="container-fluid page__container">
    <div class="page-section">
        <div class="d-flex flex-column flex-md-row align-items-center mb-4">
            <div class="flex">
                <h2 class="h2 mb-0">Teacher List</h2>
        ...
        <div class="card shadow-sm border-0">
            <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-student-name", "js-lists-values-email"]'>
                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    ...
                    <tbody class="list" id="teacher_list">
                        <?php
                        
                        $query = "SELECT * FROM users WHERE role = 2 ORDER BY created_at DESC";
                        $result = mysqli_query($db, $query);

                        if ($result && mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                // Default image if avatar is null
                                $user_img ="../uploads/" . $row['avatar'];
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="teacher_delete.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete Teacher?')">Delete</a>
                                    </td>
                                </tr>
                        ...
                        <?php 
                            ...
                            echo "<tr><td colspan='6' class='text-center p-4'>No Teacher found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
