...
// Fetch question
$question = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM quiz_questions WHERE id=$question_id"));
...
$answers = mysqli_query($db, "SELECT * FROM quiz_answers WHERE question_id=$question_id");
?>
<!DOCTYPE html>
<html lang="en"
    dir="ltr">
...
<div class="container mt-4">
    <h2>Answers for Question: <?= $question['question'] ?></h2>
    <a href="answer_form.php?question_id=<?= $question_id ?>" class="btn btn-primary mb-3">Add Answer</a>
    <a href="questions.php?quiz_id=<?= $question['quiz_id'] ?>" class="btn btn-secondary mb-3">Back to Questions</a>
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="answer_form.php?id=<?= $row['id'] ?>&question_id=<?= $question_id ?>" class="btn btn-sm btn-warning">Edit</a>
                <a href="?question_id=<?= $question_id ?>&delete_id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this answer?')">Delete</a>
            </td>
        </tr>
        <?php } ?>
    </table>
