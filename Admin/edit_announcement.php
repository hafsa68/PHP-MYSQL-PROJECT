...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE announcements SET title='$title', content='$content', is_pinned=$is_pinned WHERE id=$id";
...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" name="is_pinned" class="form-check-input" <?php if($row['is_pinned']) echo 'checked'; ?>>
