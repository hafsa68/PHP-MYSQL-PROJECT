...
$id = intval($_GET['id']);
$data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM assignments WHERE id=$id"));


if (isset($_POST['update'])) {
 $categories_id = $_POST['categories_id'] ?? 0;
    $title         = $_POST['title'] ?? '';
    $description   = $_POST['description'] ?? '';
    $instructions  = $_POST['instructions'] ?? '';
    $max_points    = $_POST['max_points'] ?? 100;
    $due_date      = $_POST['due_date'] ?? null;
mysqli_query($db, "UPDATE assignments SET categories_id='$categories_id',title='$title',description='$description',max_points='$max_points',due_date='$due_date' WHERE id=$id");
...
<form method="post" >
        ...
        <div class="mb-3">
            ...
            <input type="number" name="categories_id" class="form-control" required>
        </div>
