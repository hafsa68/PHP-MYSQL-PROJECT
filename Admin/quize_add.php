...
// Logic to add the quiz
if(isset($_POST['add_quiz'])){
    $question = mysqli_real_escape_string($db, $_POST['quiz_question']);
    $opt_a = mysqli_real_escape_string($db, $_POST['option_a']);
    $opt_b = mysqli_real_escape_string($db, $_POST['option_b']);
    $opt_c = mysqli_real_escape_string($db, $_POST['option_c']);
    $opt_d = mysqli_real_escape_string($db, $_POST['option_d']);
    $correct = mysqli_real_escape_string($db, $_POST['correct_answer']);

    $sql = "INSERT INTO tbl_quiz (quiz_question, option_a, option_b, option_c, option_d, correct_answer) 
            VALUES ('$question', '$opt_a', '$opt_b', '$opt_c', '$opt_d', '$correct')";
    
    if($db->query($sql)){
        echo "<script>alert('Question Added Successfully!'); window.location='instructor-edit-quiz.php';</script>";
    }
}
?>
    ...
    <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div class="container page__container page-section">
               ...
               <div class="container page__container page-section">
                    <div class="d-flex flex-column flex-md-row align-items-center mb-24pt">
                        <div class="flex">
                            <h1 class="h2 mb-0">Add/Edit Quiz Question</h1>
                            ...
                            <div class="card card-body">
                                <form action="" method="POST">
                                    <div class="form-group mb-4">
                                        <label class="form-label text-bold">Question Text</label>
                                        <textarea name="quiz_question" class="form-control" rows="3" placeholder="Enter your question here..." required></textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="option_a" class="form-control" placeholder="Answer A" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Option B</label>
                                                <input type="text" name="option_b" class="form-control" placeholder="Answer B" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                <label class="form-label">Option C</label>
                                                <input type="text" name="option_c" class="form-control" placeholder="Answer C" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                <label class="form-label">Option D</label>
                                                <input type="text" name="option_d" class="form-control" placeholder="Answer D" required>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group mt-4 col-md-4 pl-0">
                                        <label class="form-label text-success font-weight-bold">Select Correct Answer</label>
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" name="add_quiz" class="btn btn-primary">Save Question</button>
                                        <a href="instructor-quizzes.php" class="btn btn-outline-secondary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
