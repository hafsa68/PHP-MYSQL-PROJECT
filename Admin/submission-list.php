...
<tr>
<th>ID</th><th>Student</th><th>Assignment</th><th>Status</th><th>Grade</th><th>Action</th>
</tr>
<?php
$res = mysqli_query($db, "SELECT * FROM assignment_submissions ORDER BY id DESC");
...
<td><?= $row['grade']; ?></td>
<td>
<a href="submission-grade.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-success">Grade</a>
<a href="submission-delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete?')">Delete</a>
</td>
</tr>
<?php } ?>
</table>
