        ...
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div>
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $res = mysqli_query($db, "SELECT * FROM assignments ORDER BY id DESC");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row['due_date']; ?></td>
                            <td>
                                <a href="assignment-edit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                <a href="assignment-delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete?')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
