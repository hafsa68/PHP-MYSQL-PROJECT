...
if (isset($_POST['save'])) {
    ...
    (categories_id, title, description, instructions, max_points, due_date, attachment)
    VALUES 
    ('$categories_id', '$title', '$description', '$instructions', '$max_points', '$due_date', '$file_name')";
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <a href="assignment-list.php" class="btn btn-success">
            View Assignment
        </a>
    </form>
</div>
