    ...
    <div class="mdk-drawer-layout js-mdk-drawer-layout"
        ...
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div>
                <?php
                $id = intval($_GET['id']);
                $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM assignment_submissions WHERE id=$id"));
                ...
                if (isset($_POST['grade_now'])) {
                    ...
                    mysqli_query($db, "UPDATE assignment_submissions SET
grade='$grade',
feedback='$feedback',
graded_by='$graded_by',
graded_at=NOW(),
...
");
                ...
                <form method="post">
                    <label>Grade</label>
                    <input type="number" name="grade" value="<?= $data['grade']; ?>" class="form-control">
                    <label class="mt-2">Feedback</label>
                    <textarea name="feedback" class="form-control"><?= $data['feedback']; ?></textarea>
                    <input type="number" name="graded_by" class="form-control mt-2" placeholder="Instructor ID" required>
                    <button name="grade_now" class="btn btn-success mt-3">Submit Grade</button>
                </form>

            </div>
            <div><a href="assignment-add.php" class="btn btn-success">
                    Add Assignment
                </a></div>
