...
<div class="container">
    <h2>Announcements</h2>
    <a href="add_announcement.php" class="btn btn-success mb-3">Add New Announcement</a>
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['is_pinned'] ? 'Yes' : 'No'; ?></td>
                <td><?php echo $row['created_at']; ?></td>
                <td>
                    <a href="edit_announcement.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                    <a href="delete_announcement.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
