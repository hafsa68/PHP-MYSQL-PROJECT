...
// Student login session থেকে student_id নাও
$student_id = $_SESSION['student_id'] ?? 0;
if ($student_id == 0) {
    die("Please login as a student to submit assignments.");
}

// Assignment dropdown জন্য DB থেকে fetch করা
$assignments = mysqli_query($db, "SELECT id, title FROM assignments ORDER BY id DESC");
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['attachment']['name'])) {
        $file = time().'_'.$_FILES['attachment']['name'];
        move_uploaded_file($_FILES['attachment']['tmp_name'], "../uploads/".$file);
    }

    mysqli_query($db, "INSERT INTO assignment_submissions
        (student_id,assignment_id,submission_text,attachment_url,status)
        VALUES ('$student_id','$assignment_id','$submission_text','$file','submitted')");
...
<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data" class="mt-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="submission_text" id="submission_text" class="form-control" rows="5" placeholder="Write your answer"></textarea>
        </div>
        ...
        <button name="submit" class="btn btn-primary">Submit Assignment</button>
    </form>
</div>
